...
var Menu = React4.forwardRef(function Menu2(inProps, ref) {
  ...
  return (0, import_jsx_runtime4.jsx)(MenuRoot, _extends({
    onClose,
    anchorOrigin: {
      vertical: "bottom",
    ...
    children: (0, import_jsx_runtime4.jsx)(MenuMenuList, _extends({
...
function GlobalStyles(props) {
  return (0, import_jsx_runtime10.jsx)(GlobalStyles_default, _extends({}, props, {
...
var inputGlobalStyles = (0, import_jsx_runtime11.jsx)(GlobalStyles_default2, {
  styles: {
...
var InputBase = React9.forwardRef(function InputBase2(inProps, ref) {
  ...
  const checkDirty = React9.useCallback((obj) => {
    if (isFilled(obj)) {
      if (onFilled) {
        onFilled();
      }
...
var _excluded7 = ["disableUnderline", "components", "componentsProps", "fullWidth", "inputComponent", "multiline", "slotProps", "slots", "type"];
...
var Input = React10.forwardRef(function Input2(inProps, ref) {
  ...
  return (0, import_jsx_runtime13.jsx)(InputBase_default, _extends({
    slots: {
      root: RootSlot,
      input: InputSlot
    },
...
var FilledInput = React11.forwardRef(function FilledInput2(inProps, ref) {
  var _ref, _slots$root, _ref2, _slots$input;
  const props = useThemeProps({
    props: inProps,
    name: "MuiFilledInput"
...
var OutlinedInput = React13.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime17.jsx)(InputBase_default, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime17.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime16.jsxs)(React13.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
var Select = React14.forwardRef(function Select2(inProps, ref) {
  const props = useThemeProps({
    name: "MuiSelect",
    props: inProps
  });
  ...
  const InputComponent = input || {
    standard: (0, import_jsx_runtime18.jsx)(StyledInput, {
      ownerState
    }),
    outlined: (0, import_jsx_runtime18.jsx)(StyledOutlinedInput, {
      label,
      ownerState
    }),
    filled: (0, import_jsx_runtime18.jsx)(StyledFilledInput, {
      ownerState
    })
  }[variant];
  const inputComponentRef = useForkRef_default(ref, InputComponent.ref);
  return (0, import_jsx_runtime18.jsx)(React14.Fragment, {
    children: React14.cloneElement(InputComponent, _extends({
...
true ? Select.propTypes = {
   ...
   */
  input: import_prop_types12.default.element,
  /**
   * [Attributes](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/input#Attributes) applied to the `input` element.
   ...
   * @default false
   */
  native: import_prop_types12.default.bool,
  /**
   * Callback fired when a menu item is selected.
   *
   ...
   */
  value: import_prop_types12.default.oneOfType([import_prop_types12.default.oneOf([""]), import_prop_types12.default.any]),
  /**
   * The variant to use.
   * @default 'outlined'
   */
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-7UB25ABN.js.map
